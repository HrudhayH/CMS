...
import { getStaffProject } from '../../../../services/api';

function StaffProjectRoadmap() {
    ...
    useEffect(() => {
        ...
        const fetchProject = async () => {
            try {
                setLoading(true);
                const res = await getStaffProject(id);
    ...
    return (
        <div className="roadmap-page-container">
            ...
            <div className="breadcrumb">
                <span onClick={() => router.push('/staff/projects')}>Projects</span>
                <span className="breadcrumb-separator">/</span>
                <span onClick={() => router.push(`/staff/projects/${id}`)}>{project.title}</span>
                <span className="breadcrumb-separator">/</span>
            ...
            <div className="page-header">
                <button 
                    className="back-btn" 
                    onClick={() => router.push(`/staff/projects/${id}`)}
                >
...
StaffProjectRoadmap.getLayout = function getLayout(page) {
    return <StaffLayout>{page}</StaffLayout>;
};

export default StaffProjectRoadmap;
